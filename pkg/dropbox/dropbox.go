...
type Client interface {
	ListFolder(ctx context.Context, path string, recursive bool) ([]Entry, string, bool, error)
	ListFolderContinue(ctx context.Context, cursor string) ([]Entry, string, bool, error)
